...
class ExpressionEvaluationsTest {
    ...
    void parse_WithValidExpression_ReturnsExpressionEvaluationImpl() {
        ...
        // Act
        ExpressionEvaluation result = expressionEvaluations.parse(expression);
    ...
    void parse_WithNullExpression_ReturnsExpressionEvaluationImpl() {
        ...
        // Act
        ExpressionEvaluation result = expressionEvaluations.parse(null);
    ...
    void setApplicationContext_WithValidContext_SetsContext() {
        ...
        ExpressionEvaluation result = expressionEvaluations.parse("test");
        assertNotNull(result);
    }
    ...
    void parse_WithoutSettingApplicationContext_ThrowsException() {
        ...
        // Act & Assert
        var evalation = expressionEvaluations.parse(expression);
    ...
    void parse_MultipleCallsWithSameExpression_ReturnsDifferentInstances() {
        ...
        // Act
        ExpressionEvaluation result1 = expressionEvaluations.parse(expression);
        ExpressionEvaluation result2 = expressionEvaluations.parse(expression);
