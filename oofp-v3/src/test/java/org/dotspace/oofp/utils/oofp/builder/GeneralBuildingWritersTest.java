...
class WriteOperationsTest {
    ...
    @Test
    void set_WithBiConsumerAndValue_ReturnsWriteOperation() {
        // Arrange
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.set(setter, value);
        writer.write(obj);
    ...
    @Test
    void set_WithGetterSetterAndValue_ReturnsWriteOperation() {
        // Arrange
        TestObject obj = new TestObject();
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.set(getter, setter, value);
        writer.write(obj);
    ...
    @Test
    void setForEach_WithGetterItemSelectorAndCollection_ReturnsWriteOperation() {
        // Arrange
        TestObject obj = new TestObject();
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.setForEach(getter, itemSelector, collection);
        writer.write(obj);
    ...
    @Test
    void setForEach_WithSetterAndCollection_ReturnsWriteOperation() {
        // Arrange
        TestObject obj = new TestObject();
        obj.setItems(new ArrayList<>());
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.setForEach(setter, collection);
        writer.write(obj);
    ...
    void set_WithNullValue_SetsNullValue() {
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.set(setter, null);
        writer.write(obj);
    ...
    void setForEach_WithEmptyCollection_DoesNotModifyTarget() {
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.setForEach(setter, emptyCollection);
        writer.write(obj);
    ...
    void filter_WithObjectPredicate_WritesWhenPredicateMatches() {
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.set(setter, "new_value")
                .require(predicate);
        writer.write(obj);
    ...
    void when_WithPredicate_WritesWhenConditionMatches() {
        ...
        // Act
        WriteOperation<TestObject> writer = WriteOperations.set(setter, "_suffix")
                .require(condition);
        writer.write(obj);
