...
import org.dotspace.oofp.utils.dsl.conditional.conditional.ConditionalDsl;
import org.dotspace.oofp.utils.dsl.conditional.conditional.ConditionalRules;
...
class ConditionalRulesTest {
    ...
    @BeforeEach
    void setUp() {
        conditionalRules = new ConditionalDsl().rules();
    }
    ...
    void merge_WithEmptyOther_ReturnsThis() {
        // Arrange
        ConditionalRules<String> other = new ConditionalDsl().rules();
        conditionalRules.with(mockConsumer1);
    ...
    void genericType_WorksWithDifferentTypes() {
        // Arrange
        ConditionalRules<Integer> intRules = new ConditionalDsl().rules();
