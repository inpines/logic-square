...
@Component
@AllArgsConstructor
public class RequireParametersSteps {
    ...
    public <T> BehaviorStep<T> constraintStep() {
    ...
    public <T> BehaviorStep<T> correlationStep() {
    ...
    private <T> void eachMfCase(
        ...
        if (Optional.ofNullable(mfCase.when())
            ...
            Object value = Optional.ofNullable(expressionEvaluations.evaluate(field.getName()))
    ...
    public <T> BehaviorStep<T> propertiesStep(List<Map<String, Object>> propInfos) {
    ...
    private <T> List<GeneralViolation> validateProperties(
        ...
        propInfos.forEach(propInfo -> {
            ...
            violations.add(GeneralBuilders.supply(GeneralViolation::new)
                    .with(WriteOperations.set(
